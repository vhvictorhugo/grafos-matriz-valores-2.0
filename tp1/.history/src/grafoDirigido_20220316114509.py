    ...
    def dfs_recursiva(self, vertice, visitados):
        ...
        for vizinho in self.retornaVizinhos2(vertice):
            if vizinho not in visitados:
                ...
                pais = self.ehDescendente2(vertice)
                print(self.ehDescendente2(vertice))
...
print(grafo.retornaPais(0))
print(grafo.retornaPais(1))
print(grafo.retornaPais(2))
print(grafo.retornaPais(3))
print(grafo.retornaPais(4))
